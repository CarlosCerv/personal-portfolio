    ...
    <div className="space-y-8">
      <header className="surface-panel p-8 md:p-10">
        ...
        <p className="mt-3 max-w-3xl text-[15px] leading-[1.85] text-[#5c5d63]">
          Summary of important events in the panel and basic alert configuration.
        </p>
      </header>
      ...
      <section className="surface-panel p-7 md:p-8">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <h2 className="mt-2 text-[22px] font-semibold tracking-[-0.04em] text-[#111113]">Latest alerts</h2>
          </div>
        ...
        <div className="mt-6 space-y-3">
          {notifications.length === 0 ? (
            <p className="text-[14px] text-[#5c5d63]">No notifications yet.</p>
          ) : (
            notifications.map((n) => (
              <Link
                key={n.id}
