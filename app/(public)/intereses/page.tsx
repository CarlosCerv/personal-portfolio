...
export const metadata: Metadata = {
  title: 'Interests | Carlos Cervantes',
  description: 'Explore my passions: photography, fitness, cooking, reading, music and travel. Learn more about my interests and hobbies.',
  openGraph: {
    title: 'Interests | Carlos Cervantes',
    description: 'Explore my passions: photography, fitness, cooking, reading, music and travel.',
    url: '/intereses',
    type: 'website',
  },
}
    ...
    <main className="page-shell pt-10 pb-20 md:pt-12">
      <div className="page-band">
        <div className="space-y-4">
          <span className="eyebrow">Exploring passions</span>
          <h1 className="section-title max-w-4xl">My Interests</h1>
          <p className="section-copy max-w-2xl">
            Beyond the code: interests and passions that keep me creative, healthy and happy.
          </p>
        </div>
      </div>
        ...
        <div className="rounded-[32px] bg-[linear-gradient(180deg,#111113_0%,#1c1c21_100%)] p-8 md:p-12">
          <div className="max-w-2xl">
            ...
            <p className="mb-8 text-[15px] leading-[1.85] text-white/68">
              Follow me on social media to learn more about my experiences,
              projects and everyday life in the tech industry.
            </p>
